...
var $author$project$Model$Model$CsvFromUrl = function (a) {
	return {$: 'CsvFromUrl', a: a};
};
...
var $author$project$Model$Model$csvFromUrl = function (url) {
	return $elm$http$Http$get(
		{
			expect: $elm$http$Http$expectString($author$project$Model$Model$CsvFromUrl),
			url: url
		});
};
...
var $author$project$Model$Model$updateCsvModel = F2(
	function (content, model) {
		var _v0 = $periodic$elm_csv$Csv$parse(content);
		if (_v0.$ === 'Ok') {
			var parsed = _v0.a;
			var records = A2(
				$elm$core$Basics$composeR,
			...
			return _Utils_update(
				model,
				{columnParams: columnParams, positions: $elm$core$Maybe$Nothing, records: records});
		} else {
			var err = _v0.a;
			return A2(
				$elm$core$Debug$log,
...
var $author$project$Model$Model$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Zoom':
				var factor = msg.a;
				var newZoom = A3($elm$core$Basics$clamp, 0.5, 10, (factor * 0.005) + model.zoom);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{zoom: newZoom}),
...
var $author$project$View$Components$theme = {
	...
	dark: $rtfeldman$elm_css$Css$hex('292b34'),
	light: $rtfeldman$elm_css$Css$hex('f2f1ee'),
	light2: $rtfeldman$elm_css$Css$hex('f0dba0'),
	medium: $rtfeldman$elm_css$Css$hex('e0dfd8'),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$backgroundColor($author$project$View$Components$theme.light),
			...
			_List_fromArray(
				[
					...
					},
					{
						...
						title: $elm$core$Maybe$Just('color channel'),
					...
					},
					{
						...
						title: $elm$core$Maybe$Just('size channel'),
						values: $elm$core$Array$toList(headers)
					}),
					A2(
					...
					},
					{
						...
						title: $elm$core$Maybe$Just('label columns'),
						values: $elm$core$Array$toList(headers)
					}),
					A2(
					...
					_List_fromArray(
						[
							...
							$elm$core$String$fromFloat(params.baseSize)),
